---
title: Orb Settings
shortTitle: Orb Settings
metaDescription: Learn about the different Orb settings and how to configure them for optimal network monitoring.
section: Orb app
---
...
<img src="../../images/orb-app/orb-menu-new.png" alt="Orb Menu" width=40% style="margin-left: 2em;">
...
<img src="../../images/orb-app/share-orb-score.png" alt="Share Orb Score" width=40% style="margin-left: 2em;">

## Notifications
To receive notifications from this Orb, toggle on the Notifications setting.

<img src="../../images/orb-app/enable-notifications.png" alt="Enable Notifications" width=40% style="margin-left: 2em;">

## Orb linking
Managing Orb account links.

- To remove an existing account link, click or tap on the red "x" next to the account.
<img src="../../images/orb-app/remove-account-link.png" alt="Remove Account Link" width=40% style="margin-left: 2em;">
...
<img src="../../images/orb-app/guest-orb-link.png" alt="Link to Another Account" width=40% style="margin-left: 2em;">
...
<img src="../../images/orb-app/router-responsiveness.png" alt="Router Responsiveness" width=40% style="margin-left: 2em;">
...
<img src="../../images/orb-app/include-icmp.png" alt="Include ICMP" width=40% style="margin-left: 2em;">
...
<img src="../../images/orb-app/orb-measure-server.png" alt="Orb Measure Server" width=40% style="margin-left: 2em;">
...
<img src="../../images/orb-app/change-endpoint.png" alt="Change Endpoint" width=40% style="margin-left: 2em;">
